...
module.exports.setRouter = (app) => {
    ...
    app.get(`${baseUrl}/view/request/sent/:userId`, auth.isAuthorized, friendController.getAllRequestSent);
    /**
     * @apiGroup friends
     * @apiVersion  1.0.0
   ...
   app.get(`${baseUrl}/view/request/recieved/:userId`, auth.isAuthorized, friendController.getAllRequestRecieved);
   /**
    * @apiGroup friends
    * @apiVersion  1.0.0
   ...
   */
    ...
    app.post(`${baseUrl}/send/request`, auth.isAuthorized,friendController.sendFriendRequest);
    /**
     * @apiGroup friends
     * @apiVersion  1.0.0
   ...
   app.post(`${baseUrl}/accept/request`, auth.isAuthorized,friendController.acceptFriendRequest);
   /**
    * @apiGroup friends
    * @apiVersion  1.0.0
  ...
  app.post(`${baseUrl}/reject/request`, auth.isAuthorized,friendController.rejectFriendRequest);
  /**
   * @apiGroup friends
   * @apiVersion  1.0.0
 ...
 app.post(`${baseUrl}/cancel/request`, auth.isAuthorized,friendController.cancelFriendRequest);
 /**
  * @apiGroup friends
  * @apiVersion  1.0.0
