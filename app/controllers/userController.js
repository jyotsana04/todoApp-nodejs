...
const applicationUrl = 'http://todo.meproject.pw/user' //url of frontend application
                        ...
                        newUser.save((err, newUser) => {
                            if (err) {
                                ...
                                let mailOptions = {
                                    ...
                                    text: `Hello ${newUserObj.firstName}, Thank you for signing up to my app.`
                                }
...
let resetPasswordFunction = (req, res) => {
    ...
    let resetPassword = (tokenDetails) => {
        return new Promise((resolve, reject) => {
            ...
            let options = {
                resetPasswordToken: tokenDetails.token
            }
            ...
            UserModel.update({ 'email': req.body.email }, options).exec((err, result) => {
                if (err) {
                    ...
                    let mailOptions = {
                        ...
                        text: `<h4> Hi ${tokenDetails.userDetails.firstName}</h4>
                                ...
                                <br> <a href="${applicationUrl}/reset-password/${options.resetPasswordToken}">Click Here</a>                                 
                            </p>
    ...
    let findUser = () => {
        ...
        return new Promise((resolve, reject) => {
            if (req.body.resetPasswordToken) {
                console.log("req body resetPasswordToken is there");
                console.log(req.body);
                ...
                let apiResponse = response.generate(true, '"resetPasswordToken" parameter is missing', 400, null)
                reject(apiResponse)
            }
        })
    }
            ...
            UserModel.update({ 'userId': userDetails.userId }, options).exec((err, result) => {
                if (err) {
                    ...
                    let mailOptions = {
                        ...
                        text: `<h4> Hi ${userDetails.firstName}</h4>
                        <p>
